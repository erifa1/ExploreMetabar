...
golem::fill_desc(
  pkg_name = "ExploreMetabar", # The Name of the package containing the App 
  pkg_title = "ExploreMetabar", # The Title of the package containing the App 
  pkg_description = "Shiny application to explore metabarcoding data (16S, ITS...)", # The Description of the package containing the App 
  author_first_name = "Etienne", # Your First Name
  author_last_name = "Rifa",  # Your Last Name
  author_email = "etienne.rifa@inrae.fr",      # Your Email
